    ...
    <ul class="nano-content">
      <li class="sub-menu">
        ...
        <ul>
          ...
          <li><a href="liste_eleve.php"><i class="fa fa-circle-o"></i>Afficher les Eleve</a>
          </li>
          <li><a href="Form_ajouter_eleve.php"><i class="fa fa-user-plus"></i>Ajouter un Eleve</a>
          </li>
        </ul>
      </li>
      <li class="sub-menu">
        ...
        <ul>
          ...
          <li><a href="formajoutparent.php"><i class="fa fa-user-plus"></i>Ajouter un Compte parent</a>
          </li>
        </ul>
      </li>
      <li class="sub-menu">
        <a href="javascript:void(0);"><i class="fa fa-users"></i><span>Les Directeur</span><i class="arrow fa fa-angle-right pull-right"></i></a>
        <ul>
          <li><a href="liste_directeur.php"><i class="fa fa-circle-o"></i>Afficher les Directeurs</a>
          </li>

          <li><a href="Form_ajouter_directeur.php"><i class="fa fa-user-plus"></i>Ajouter un Directeur </a>
          </li>
        </ul>
      </li>
      <li class="sub-menu">
        <a href="javascript:void(0);"><i class="fa fa-users"></i><span>Les Ecoles</span><i class="arrow fa fa-angle-right pull-right"></i></a>
        <ul>
          <li><a href="liste.php?type=professeur"><i class="fa fa-circle-o"></i>Afficher les Ecoles</a>
          </li>

          <li><a href="form_ajout_ecole.php"><i class="fa fa-user-plus"></i>Ajouter un Ecoles</a>
          </li>
        </ul>
      </li>
      
      <li class="sub-menu">
        <a href="profile.php"><i class="fa fa-files-o"></i><span>Les Notes</span></a>
      </li>
      <li class="sub-menu">
        ...
        <div class="col-sm-3">
          <div class="panel">
            <div class="panel-icon">
              <i class="fa fa-user-secret admin-stat"></i>
            </div>
