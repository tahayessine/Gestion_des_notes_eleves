...
<header class="main-header" id="main-header" style="padding:0.1px 0.1px 0.1px 70px; margin:0px; background-color:#367FA9">
    <!-- Logo -->
    <h2>Administrateur:   <?=$_SESSION["username"]?></h2>
</header>
    ...
    <div id="leftside-navigation" class="nano">
        <ul class="nano-content">
            ...
            <li class="sub-menu">
                ...
                <ul>
                    <li><a href="liste_directeur.php"><i class="fa fa-circle-o"></i>Afficher les Directeurs</a></li>
                    <li><a href="Form_ajouter_directeur.php"><i class="fa fa-user-plus"></i>Ajouter un Directeur</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:void(0);"><i class="fa fa-users"></i><span>Les Ecoles</span><i class="arrow fa fa-angle-right pull-right"></i></a>
                <ul>
                    <li><a href="liste_ecole.php"><i class="fa fa-circle-o"></i>Afficher les Ecoles</a></li>
                    <li><a href="form_ajout_ecole.php"><i class="fa fa-user-plus"></i>Ajouter un Ecoles</a></li>
                </ul>
