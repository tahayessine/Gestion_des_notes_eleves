...
<aside class="sidebar" id="sidebar">
  <div id="leftside-navigation" class="nano">
    <ul class="nano-content">
          ...
          <li class="sub-menu">
            <a href="profile.php"><i class="fa fa-files-o"></i><span>Cours en ligne </span></a>
          </li>
          <li class="sub-menu">
            <a href="profile.php"><i class="fa fa-files-o"></i><span>Emploi de Temps </span></a>
          </li>
          <li class="sub-menu">
            <a href="moyenne_eleve.php"><i class="fa fa-files-o"></i><span>Moyenne </span></a>
          </li>
      
      <li class="sub-menu">
        <a href="affiche_note_eleve.php"><i class="fa fa-files-o"></i><span>Les Notes</span></a>
      </li>
      <li class="sub-menu">
      ...
      <li class="sub-menu">
        <a href="login.php"><i class="fa fa-sign-out"></i><span>Déconnecter</span></a>
      </li>
    </ul>
  </div>
</aside>
